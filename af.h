...
#define MY_AF_EVENT_CLIENT				1
#define MY_AF_EVENT_DB					2
#define MY_AF_EVENT_DB2					3
#define MY_AF_EVENT_UNKNOWN				-1000

#define MY_AF_SEND_NOTHING				0
#define MY_AF_SEND_IDLE					1
#define MY_AF_SEND_DB					2
#define MY_AF_SEND_DB2					3

#define MY_AF_STATE_IDLE				0
#define MY_AF_STATE_W_TIMEOUT			1
#define MY_AF_STATE_W_DB				2
#define MY_AF_STATE_W_DB2				3
...
int af_state_w_db(int messageType, EC_UTILS* utils, EQX_MSG *emsg, AF_INSTANCE *instance, char* err);
